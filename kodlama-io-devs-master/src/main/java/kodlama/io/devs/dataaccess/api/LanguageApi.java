package kodlama.io.devs.dataaccess.api;
...
public class LanguageApi {
  ...
  @PostMapping("/add")
  CreateLanguageRequest add(@RequestBody CreateLanguageRequest createLanguageRequest)
      throws Exception {
  ...
  @PutMapping("/update")
  LanguageResponse update(
      @RequestParam int id, @RequestBody UpdateLanguageRequest updateLanguageRequest)
      throws Exception {
